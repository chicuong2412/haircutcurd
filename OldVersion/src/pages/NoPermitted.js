...
export default function NoPermitted() {
    return (
        <div>
            <use>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" className="whistle">
                    {/* <metadata>SvgVectorIcons:http://www.onlinewebfonts.com/icon</metadata> */}
            ...
            <h1 className='head403'>403</h1>
            <h2 className='des403'>Not this time, access forbidden!</h2>
        </div>
    )
}
