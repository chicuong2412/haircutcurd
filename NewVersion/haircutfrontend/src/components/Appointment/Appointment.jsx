...
export default function Appointment() {
    ...
    return (
        <>
            ...
            <Table
                colDefsIn={[
                    { headerName: "ID", field: "id", resizable: true, filter: false },
                    {
                        field: "worker", resizable: true, cellRenderer: (params) => {
                            return (
                    ...
                    {
                        field: "customer", resizable: true, cellRenderer: (params) => {
                            return (
                                <>{params.data.customer.id}</>
                            )
                        }, resizable: true , filter: false
                    },
                    { headerName: "Status", field: "status", resizable: true , filter: false  },
                    { headerName: "DateTime", field: "dateTime", resizable: true , filter: false },
                    { field: "idLocation", resizable: true },
                    {
                        headerName: "Service/Combo", field: "service_combo", cellRenderer: (params) =>
